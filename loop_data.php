...
<div id="content12">
    <div class="PA1">
        ...
        <div class="pnentriespage">
            ...
            <input type="number" class="pagenum"></input>
        </div>
        <div class="filterpage">
            <div class="pagefilter6">Filter By</div>
            <input type="number" class="pagefilteby">
        </div>
...
<!--            <h4>-->
    ...
    <div class="PA2">
        ...
        <button class="PA2button">
            <a href="#pa2pre">
                <h4 class="pa2pre">Previous</h4>
            </a>
        </button>
        <h4 class="pa2pa">Page 1 Of 5</h4>
        <button class="PA2button">
            <a href="#pa2next">
                <H4 class="pa2next">Next</H4>
            </a>
        </button>
        <button class="PA2button">
