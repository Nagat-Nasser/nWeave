<div id="sidebar">//sidebar
    ...
    <div class="navigation">
        <ul class="menu">
            ...
            <div class="sidebarmenu">
                ...
                <details>
                    ...
                    <div class="dropdown-wrapper">
                        <ul class="ul">
                            <li class="a"><a href="#" class="anui Geograpy" STYLE="font-size: 21px;">Geograpy</a></li>
                            <li class="a"><a href="#" class="anui" STYLE="font-size: 21px;">Properties </a></li>
                            <li class="a"><a href="#" class="anui" STYLE="font-size: 20px;">Transactions</a></li>
                            <li class="a"> <a href="#" class="anui" STYLE="font-size: 21px;">Tacos</a></li>
                            <li class="a"><a href="#" class="anui Tenancy" STYLE="font-size: 21px;">Tenancy</a>
                        </ul>
                    </div>
                </details>
                <ul class="ul">
            ...
            <button name="Reset" class="btn1">Reset</button>
