...
<div class="classesimg1_1">
    ...
    <div class="color colorone_others" style="background-color:#f54275;" >
        <abbr class="abbrothers" title="Others <?php echo ceil($others_circle_space); ?>"
...
<?php }}?>
                ...
                Transactions
                  ...
                  <div class="classesimg1_4_2">
                      ...
                      <div class="color colorone_others" style="background-color:#f54275;" >
                          <abbr class="abbrothers" title="Others <?php echo ceil($others_circle_space); ?>"
                          <span class="Othersthree" style="margin-left: 13px;">Others</span>
                      </abbr>
                      </div>
                      <style>
                          .Othersthree {
