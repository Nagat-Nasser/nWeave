<div class="navbar">
  <div class="container nav-container">
    ...
    top: 0;
">
            <span class="anui filltermedia">
              Filters</span>
          </summary>
          <div class="dropdown-wrapper">
            <ul class="ul">
              <li class="a"><a href="#" class="anui Geograpy" style="width: 91px;">Geograpy</a></li>
              <li class="a"><a href="#" class="anui">Properties Type</a></li>
              <li class="a"><a href="#" class="anui">Transactions</a></li>
              <li class="a"> <a href="#" class="anui">Tacos</a></li>
              <li class="a"><a href="#" class="anui Tenancy">Tenancy</a>
            </ul>
          </div>
        </details>
      </li>
