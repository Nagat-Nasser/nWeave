<div id="content13">
    ...
    <div id="length2">
        ...
        <div class="divchart1" style="height:<?php echo number_format((28071422893.129/7)/100000000,1)?>px">vol ()</div>
        <?php        for($loop_counter=0 ; $loop_counter<=6 ; $loop_counter++){?>
        <div class="divchart1" style="height:<?php echo number_format((28071422893.129/7)/100000000,1)?>px"><?php  echo   $vol_counter .' B' ?> </div>
        <?php $vol_counter -=5;
        }?>
        <?php $vol_counter=5;
